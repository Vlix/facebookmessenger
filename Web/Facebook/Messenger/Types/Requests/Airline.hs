...
instance ToJSON AirlineField where
    toJSON (AirlineField label value) = object [ "label" .= label
                                               , "value" .= value
                                               ]
...
instance FromJSON AirlinePassengerInfo where
    parseJSON (Object o) = AirlinePassengerInfo <$> o .: "passenger_id"
                                                <*> o .:? "ticket_number"
                                                <*> o .: "name"
    parseJSON wat = typeMismatch "AirlinePassengerInfo" wat

instance FromJSON AirlineItineraryFlightInfo where
    parseJSON (Object o) = AirlineItineraryFlightInfo <$> o .: "connection_id"
                                                      <*> o .: "segment_id"
                                                      <*> o .: "flight_number"
                                                      <*> o .:? "aircraft_type"
                                                      <*> o .: "departure_airport"
...
instance FromJSON AirlineAirport where
    parseJSON (Object o) = AirlineAirport <$> o .: "airport_code"
                                          <*> o .: "city"
                                          <*> o .:? "terminal"
                                          <*> o .:? "gate"
...
instance FromJSON AirlineFlightInfo where
    parseJSON (Object o) = AirlineFlightInfo <$> o .: "flight_number"
                                             <*> o .: "departure_airport"
                                             <*> o .: "arrival_airport"
                                             <*> o .: "flight_schedule"
...
instance FromJSON AirlineBoardingPass where
    parseJSON (Object o) = AirlineBoardingPassQRCode <$> o .: "passenger_name"
                                                     <*> o .: "pnr_number"
                                                     <*> o .:? "travel_class"
                                                     <*> o .:? "seat"
                                                     <*> o .:? "auxiliary_fields"
